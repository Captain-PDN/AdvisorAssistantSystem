    ...
    <div id="div-form" class="col-lg-6 col-md-6">
        ...
        <div class="center-form" >
            <form>
                ...
                <button type="submit" class="btn " ><a href="loginAdmin.php" style="color:white;">as Administrator</a></button>
                <p style="font-size: 20px;margin-top: 20px">OR</p>
                <button type="submit" class="btn " ><a href="loginStudentAndAdvisor.php" style="color:white;">as Advisor / Student</a></button>
            </form>
        </div>
    </div>
</div>
