        ...
        <div id="div-form" class="col-lg-6 col-md-6">
            ...
            <div class="sign-up-center-form">
                ...
                <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <input type="text" name="password" id="adminInputPassword1" placeholder= "Password">
                    </div>
                    <div class="form-group">
                        <input type="text" name="confirm_password" id="adminInputPassword1" placeholder= "Confirm Password">
                    </div>
                    ...
                    if (isset($_POST["submit"])){
                        if($_POST['username'] != ''&& $_POST['password'] != ''&& $_POST['name'] != ''&& $_POST['confirm_password'] != ''){
                            if($_POST["password"] == $_POST["confirm_password"]){
                                ...
                                echo "<script type='text/javascript'>alert('ERROR : Password and confirm password not match');</script>";
                            }
                        }
                        else{
