        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav">
                    ...
                    <li><a class="active" href="newAdvisor.php">Add New Advisor</a></li>
        ...
        <div id="content-new-Advisor" >
            ...
            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
                <div class="form-group row">
                    <label for="exampleFormControlInput1" class="col-sm-3 col-form-label">Advisor Name</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control  form-control-lg" name="firstName" id="inputAdvisorName" placeholder="Advisor Name">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="exampleFormControlInput1" class="col-sm-3 col-form-label">Advisor Lastname</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control  form-control-lg" name="lastName" id="inputAdvisorLastname" placeholder="Advisor  Lastname">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="exampleFormControlInput1" class="col-sm-3 col-form-label">KU Email address</label>
                    <div class="col-sm-9">
                        <input type="email" class="form-control  form-control-lg" name="email" id="inputAdvisorEmail" placeholder="advisorEmail@ku.th">
                    </div>
                </div>
