...
<!--        <h1 style="text-align: center">Add New Advisor</h1>-->
        <div id="content-new-Advisor" >
            <h1 style="text-align: center;margin-bottom: 35px;">Add New Advisor</h1>
            <form>
                <div class="form-group row">
                    <label for="exampleFormControlInput1" class="col-sm-3 col-form-label">Advisor Name</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control  form-control-lg" id="inputAdvisorName" placeholder="Advisor Name">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="exampleFormControlInput1" class="col-sm-3 col-form-label">Advisor Lastname</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control  form-control-lg" id="inputAdvisorLastname" placeholder="Advisor  Lastname">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="exampleFormControlInput1" class="col-sm-3 col-form-label">KU Email address</label>
                    <div class="col-sm-9">
                        <input type="email" class="form-control  form-control-lg" id="inputAdvisorEmail" placeholder="advisorEmail@ku.ac.th">
                    </div>
                </div>
