            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="#newAdvisor">Add New Advisor</a></li>
                        <li><a class="active" href="#newStudent">Add New Student</a></li>
            ...
            <div id="content-new-Advisor" >
                ...
                <form>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control  form-control-lg" id="inputStudentName" placeholder="Student Firstname">
                        </div>
                    </div>
                    <div class="form-group row">
